        ...
        <table class="table table-hover table-secondary table-borderless">
          <tbody>
            <tr v-for="(recipient, index) in recipients" :key="recipient.address">
              ...
              <td>
                <a class="text-white text-decoration-none" href="#">Edit</a> | 
                <a class="text-white text-decoration-none" href="#" data-bs-toggle="modal" :data-bs-target="'#removeRecipientModal'+index">Remove</a>
              </td>
